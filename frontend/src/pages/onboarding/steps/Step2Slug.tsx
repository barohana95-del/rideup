...
export default function Step2Slug({
  ...
  return (
    ...
    >
      ...
      >
        <Globe className="w-5 h-5 shrink-0" style={{ color: '#1E63D6' }} />
        <p className="text-base font-mono flex items-center gap-1 truncate" style={{ color: '#0A1F44' }}>
          <span style={{ color: '#6B7C95' }}>https://</span>
          <span className="font-bold" style={{ color: avail ? '#1E63D6' : '#0A1F44' }}>
            {value || 'your-event'}
          </span>
          <span style={{ color: '#6B7C95' }}>.rideup.co.il</span>
        </p>
      </div>
      ...
      <div className="relative">
        <input
          ...
          style={{
            background: '#fff',
            border: error ? '2px solid #ef4444' : avail ? '2px solid #1E63D6' : '2px solid rgba(30,99,214,0.15)',
            borderRadius: '16px',
            color: '#0A1F44',
          }}
          maxLength={60}
        ...
        <div className="absolute top-1/2 left-4 -translate-y-1/2">
          {checking && <Loader2 className="w-5 h-5 animate-spin" style={{ color: '#6B7C95' }} />}
          {!checking && avail === true && (
            <span
      ...
      <div className="mt-3 min-h-[24px] text-sm">
        ...
        {!error && checking && <p style={{ color: '#6B7C95' }}>בודק זמינות...</p>}
        {!error && avail === true && (
          <p className="font-semibold" style={{ color: '#1E63D6' }}>
      ...
      {!value && (
        <div className="mt-8">
          <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#6B7C95' }}>
            רעיונות
          </p>
      ...
      <p className="mt-8 text-xs text-center" style={{ color: '#6B7C95' }}>
