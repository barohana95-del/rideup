...
export default function NavButtons({
  ...
  return (
    <div className="flex items-center justify-between gap-4 mt-10 pt-6 border-t" style={{ borderColor: 'rgba(30,99,214,0.1)' }}>
      <button
        onClick={onBack}
        disabled={isFirst}
      ...
      <button
        ...
        style={{
          background: canGoNext ? '#1E63D6' : '#EAF1FB',
          color: canGoNext ? '#fff' : '#6B7C95',
          boxShadow: canGoNext ? '0 6px 20px -6px rgba(30,99,214,0.5)' : 'none',
